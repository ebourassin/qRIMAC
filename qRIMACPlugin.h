...
#ifndef Q_RIMAC_PLUGIN_HEADER
#define Q_RIMAC_PLUGIN_HEADER
...
**/
class qRIMACPlugin : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	Q_INTERFACES(ccStdPluginInterface)
	Q_PLUGIN_METADATA(IID "cccorp.cloudcompare.plugin.qRIMAC")

public:

	//! Default constructor
	explicit qRIMACPlugin(QObject* parent = 0);

	//inherited from ccPluginInterface
	virtual QString getName() const override { return "qRIMACPlugin"; }
	virtual QString getDescription() const override { return "RIMAC plugin (add description here)"; }
